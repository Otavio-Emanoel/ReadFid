...
const comics = [
  {
    id: 1,
    title: "Raios & Gritos",
    author: "Alexandre Barbosa, Andrade Ferreira, Digo Freitas, Fabio Coala, Guilherme Assumpção, Gustavo Sanchez, João F. Souza, Mauro de Abreu, Paulo Siqueira, Sam Coza, Seri",
    genre: "Aventura, Terror, Sci-Fi",
    rating: 5.0,
    publishDate: "2022",
    pages: 28,
    cover: "/Raios&Gritos.png",
    description: "Em Monstro do Porto, surge uma criatura que busca por vingança!",
    synopsis: "Em Monstro do Porto, surge uma criatura que busca por vingança! Aventure-se pelo espaço atrás de uma Carga Intacta! Entre no mundo bizarro do Barão Von Torpe! Conheça os Freedom Rangers, os grandes “heróis” do universo! E mais: Olfato, The Zempregado e Charles Miller!",
  },
  // {
  //   id: 2,
